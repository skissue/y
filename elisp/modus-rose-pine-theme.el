;;; modus-rose-pine-theme.el --- Rose Pine palette on top of modus-themes -*- lexical-binding:t -*-
...
;; A dark theme using the Rose Pine "Main" palette
;; (https://rosepinetheme.com/), built as a derivative of the Modus
;; themes (v5.2+).  Any palette entry not mapped here falls back to
;; `modus-themes-vivendi-palette', so the theme is functional
;; immediately and can be tightened incrementally.
;;
...
;;   (load-theme 'modus-rose-pine :no-confirm)

;;; Code:

(require 'modus-themes)

(defgroup modus-rose-pine nil
  "A Rose Pine palette theme built on top of `modus-themes'."
  :group 'faces
  :group 'modus-themes
  :prefix "modus-rose-pine-"
  :tag "Modus Rose Pine")

(defconst modus-rose-pine-palette
  '(
;;; Named colors -- the Rose Pine "Main" palette
...
(defcustom modus-rose-pine-palette-overrides nil
  "Overrides for `modus-rose-pine-palette'.

Mirror the elements of `modus-rose-pine-palette' (or any entry of
`modus-themes-vivendi-palette'), overriding their value.  See
Info node `(modus-themes) Palette overrides' for details."
  :group 'modus-rose-pine
  :package-version '(modus-rose-pine . "0.1.0")
...
(modus-themes-theme
 'modus-rose-pine
 'modus-rose-pine
 "Dark theme using the Rose Pine palette, derived from `modus-themes'."
 'dark
 'modus-themes-vivendi-palette
 'modus-rose-pine-palette
 'modus-rose-pine-palette-overrides)
...
(provide-theme 'modus-rose-pine)
;;; modus-rose-pine-theme.el ends here
